...
class NewsAnalysisRequest(BaseModel):
    ...
    api_key: str | None = Field(default=None, description="Optional legacy API Key field")
...
class NewsAnalysisResponse(BaseModel):
    ...
    analysis_engine: str = Field(default="Institutional Financial NLP Engine", description="Engine used for synthesis")
