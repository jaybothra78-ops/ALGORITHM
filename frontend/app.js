...
App.Screener = {
  ...
  updateMetricsRibbon(data) {
    const totalEl = document.querySelector('#metric-total-signals') || document.querySelector('#metric-scanned');
    const flaggedEl = document.querySelector('#metric-flagged');
  ...
  showToast(message) {
    ...
    if (!toast) {
      ...
      toast.style.cssText = `
        ...
        bottom: 24px;
        right: 24px;
        background: linear-gradient(135deg, #fffdfa 0%, #fbf4ea 100%);
        ...
        font-size: 0.85rem;
        font-weight: 700;
        box-shadow: 0 10px 30px rgba(70, 55, 35, 0.15), 0 2px 8px rgba(180, 83, 9, 0.12);
        z-index: 99999;
        max-width: 420px;
        line-height: 1.5;
